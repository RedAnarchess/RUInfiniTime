...
Error::Error(System::BootErrors error) {
  ...
  lv_label_set_text_static(warningLabel, "Предупреждение");
  ...
  if (error == System::BootErrors::TouchController) {
    lv_label_set_text_static(causeLabel, "Обнаружена ошибка сенсорного контроллера.");
  }
  ...
  lv_label_set_text_static(tipLabel, "Если у вас возникли проблемы, а ваше устройство находится на гарантии, обратитесь к продавцу устройства.");
  ...
  lv_label_set_text_static(lblOk, "Приступайте к работе");
